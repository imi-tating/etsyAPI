...
function toggleHelper() {
  if ($(".fa-question-circle").attr("data-toggle") === "off") {
    ...
    $("#alerts").append('<p>Click the <i class="fas fa-cloud" ></i> button to generate a Word Cloud.</p><p class="tip">Click on cards below to highlight: this will limit the Word Cloud results to only include those reviews.</p><p class="tip">To save Word Cloud image: tap + hold (mobile device) | right-click (desktop).</p>');
  } else {
    $("#alerts").removeClass().empty();
